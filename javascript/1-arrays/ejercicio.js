...
function vaciarCarritoConTotal() {
    ...
    for (const producto of carrito) {
        ...
        carrito.splice(carrito.indexOf(producto), 0);
    }

    for (const producto of carrito) {
        carrito.splice(carrito.indexOf(producto), 3);
    }
...
function cuentaDeAlumnos() {
    ...
    const uniongrupo = grupoA.concat(grupoB)
    console.log("La cantidad de alumnos en el nuevo grupo es: " + uniongrupo.length)
}
